  ...
  return (
    ...
    >
      <button 
        ...
        className={` ${selectedSection === ConfigurationSection.ChatVisual ? 'bg-[#2e2e2e]' : ''} hover:bg-[#4d4d4d] rounded-sm p-2`}
      >
      ...
      <button
        ...
        className={` ${selectedSection === ConfigurationSection.IgnoredUsers ? 'bg-[#2e2e2e]' : ''} hover:bg-[#4d4d4d] rounded-sm p-2`}
      >
      ...
      <button
        ...
        className={` ${selectedSection === ConfigurationSection.NameReplacement ? 'bg-[#2e2e2e]' : ''} hover:bg-[#4d4d4d] rounded-sm p-2`}
      >
      ...
      <button
        ...
        className={` ${selectedSection === ConfigurationSection.TTS ? 'bg-[#2e2e2e]' : ''} hover:bg-[#4d4d4d] rounded-sm p-2`}
      >
