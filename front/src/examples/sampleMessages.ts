...
export const SampleMessages: Array<ChatMessageData> = [
  {
    ...
    'contentParts': [
      {
        'content': 'pato ',
        'type': 'text',
        'originalContent': 'pato'
      },
      {
        'content': 'falta ',
        'type': 'text',
        'originalContent': 'falta'
      },
      {
        'content': 'democratización ',
        'type': 'text',
        'originalContent': 'democratización'
      }
    ]
  },
  {
    ...
    'contentParts': [
      {
        'content': '#estoenphpnopasa ',
        'type': 'text',
        'originalContent': '#estoenphpnopasa'
      }
    ]
  },
  {
    ...
    'contentParts': [
      {
        'content': 'emotesv2_6cedb02e7ad046abafdbc1883c61317e',
        'type': 'emote',
        'originalContent': 'patito70Peek'
      }
    ]
  },
  {
    ...
    'contentParts': [
      ...
      },
      {
        'content': 'está ',
        'type': 'text',
        'originalContent': 'está'
      },
      {
        'content': 'quemando ',
        'type': 'text',
        'originalContent': 'quemando'
      },
      {
        'content': 'ya ',
        'type': 'text',
  ...
  },
  {
    ...
    'badges': [
      ...
      {
        'id': 'subscriber',
        'url': 'https://static-cdn.jtvnw.net/badges/v1/551b5a68-3313-4d41-bd3f-9cbae4233732/2'
      }
    ],
    'contentParts': [
      {
